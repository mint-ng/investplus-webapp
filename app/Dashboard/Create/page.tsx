...
const formValidationSchema = yup.object().shape({
  duration: yup.number().required("Select a duration"),
  amount: yup.number().required("Select an amount"),
  investDuration: yup.number().required("Select an investment duration"),
    ...
    <p>Dashboard</p>
      ...
      >
        {({
          ...
          >
            <h2 className="mb-[19px] text-[16px] font-semibold border-b-1 border-[#DFDFDF] pb-3">
              Create Investment
            </h2>
            <CustomSelect
            ...
            <CustomSelect
              ...
              required
              error={
                (touched.investDuration && errors.investDuration) || undefined
              }
            />
            ...
            <div className="flex gap-1 items-start bg-pink-100 p-1 w-[70%] rounded-[8px]">
              <RedIcon />
              <span className="text-[9px] text-[#FF466A]">
                A 10% withholding tax applies to your investment interest
              </span>
            </div>
